...
import { saveContact, State } from '@/actions/common/saveContact'
...
export default function ContactDetail(props: ContactDetailProps) {
  ...
  return (
    <>
      <Transition show={isPostSave} as={Fragment}>
                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                  <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                    <div className="sm:flex sm:items-start">
                      <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-green-100 sm:mx-0 sm:h-10 sm:w-10">
                        <CheckCircleIcon
                          className="h-8 w-8 text-green-400 ml-1"
                          aria-hidden="true"
                        />,
                      </div>
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        <h3 className="text-base font-semibold leading-6 text-gray-900">
                          Successfully saved the contact data!
                        </h3>
                        <div className="mt-2">
                  ...
                  <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    <button
                      ...
                      onClick={() => setIsPostSave(false)}
                      data-autofocus
                    >
                      Continue editing this contact
                    </button>
                    <button
                      type="button"
