...
export type PrismaHandlerSingle = (
  addedItems: (string | null | undefined)[],
  removedItems: string[],
) => Promise<void>

export type PrismaHandlerMultiple<T extends Record<string, any>> = (
  addedItems: Record<string, any>[],
...
export type UserTimeInformation = {
  user: {
    id: string
    name: string
  }
