          ...
          >
            ...
            <div className="">
              <div className="max-w-8xl mx-auto">
                <div className="grid grid-cols-3 gap-px sm:grid-cols-3 lg:grid-cols-3">
                  {[
                    { name: 'Total contacts', value: 723, unit: '' },
                    { name: 'Improved contacts', value: 123, unit: '' },
                    { name: 'Improved details', value: 5, unit: '' },
                  ].map((stat) => (
            ...
            <nav className="mt-6">
              <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
                <MobileNavItem href="/about">Contacts list</MobileNavItem>
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        ...
        <NavItem href="/articles">Connected accounts</NavItem>
